...
public final class EncryptedNumber {
   ...
   * {@link PaillierPrivateKey#decrypt(EncryptedNumber)} for more details.
   *
   ...
   * See {@link PaillierContext#decreaseExponentTo(EncryptedNumber, int)} for details.
   *
   ...
   * {@link PaillierContext#add(EncryptedNumber, EncryptedNumber)} for more details.
   *
   ...
   * {@link PaillierContext#add(EncryptedNumber, EncodedNumber)} for more details.
   *
