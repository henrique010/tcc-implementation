...
import com.example.tcc_implementation.paillier.util.HashChain;
...
public final class EncodedNumber {
   ...
   * {@link PaillierContext#decodeBigInteger(EncodedNumber)} for details.
   *
   ...
   * {@link PaillierContext#decodeDouble(EncodedNumber)} for details.
   *
   * @return the decoded number.
   ...
   * {@link PaillierContext#decodeLong(EncodedNumber)} for details.
   *
   * @return the decoded number.
   ...
   * See {@link PaillierContext#decreaseExponentTo(EncodedNumber, int)} for details.
   *
   ...
   * {@link PaillierContext#encrypt(EncodedNumber)} for details.
   *
   ...
   * {@link PaillierContext#add(EncodedNumber, EncryptedNumber)} for details.
   *
   ...
   * {@link PaillierContext#add(EncodedNumber, EncodedNumber)} for details.
   *
